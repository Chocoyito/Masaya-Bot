...
class Voice(commands.Cog):
    ...
    async def join(self, ctx):
        ...
        voice1 = get(bot.voice_clients, guild=ctx.guild)
    ...
    async def play(self, ctx, *url: str):
        ...
        voicenew = get(bot.voice_clients, guild=ctx.guild)
    ...
    async def skip(self, ctx):
        voice3 = get(bot.voice_clients, guild=ctx.guild)
        queues.clear()
    ...
    async def reset(self, ctx):
        voice4 = get(bot.voice_clients, guild=ctx.guild)
        try:
            voice4.stop()
        except:
